  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      >
        ...
        >
          CommUnity ("we," "us," or "our") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you use our mobile application
          ("App"). Please read this Privacy Policy carefully. By using the App,
        ...
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        >
        ...
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Account Information: Email address, password (stored securely and
          hashed), and any other information you provide during registration
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • User-Generated Content: Reports, descriptions, images, and other
          content you post through the App
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Contact Information: Contact details you provide when reporting lost
          or found items
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Preferences: Notification preferences, distance radius settings, and
          unit preferences (kilometers or miles)
        </ThemedText>
        ...
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Location Data: GPS coordinates and location information when you use
        ...
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Usage Information: How you interact with the App, features you use,
          reports you view, and time spent in the App
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Push Notification Tokens: Device tokens used to send push
          notifications
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Log Data: IP address, access times, app crashes, and other
          diagnostic data
        </ThemedText>
        ...
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Supabase: We use Supabase for authentication and database services.
          Supabase's privacy practices are governed by their own privacy policy.
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Expo: We use Expo services for push notifications, location
          services, and other app functionality. Expo's privacy practices are
        ...
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Process and display user-generated content, including reports and
          images
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
          • Provide location-based services and filter content based on your
          location
        </ThemedText>
        <ThemedText style={[styles.listItem, { color: uiTheme.textSecondary }]}>
        ...
        <ThemedText
          style={[styles.paragraph, { color: uiTheme.textSecondary }]}
        >
          Reports, descriptions, images, and location data you post are publicly
          visible to other App users within your selected distance radius. This
          information is shared to enable community features.
        </ThemedText>
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        >
        ...
        >
          ...
          investigate fraud, or comply with a legal process.
        </ThemedText>
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        >
        ...
        >
          ...
          you and to receive a copy of your data in a portable format.
        </ThemedText>
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        >
        ...
        <ThemedText
          style={[styles.paragraph, { color: uiTheme.textSecondary }]}
        >
          You can update your account information, including email address and
          preferences, directly through the App settings.
        </ThemedText>
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        >
        ...
        >
          ...
          contacting us or using account deletion features in the App. We will
          delete your information except where we are required to retain it for
          legal purposes.
        </ThemedText>
        <ThemedText
          style={[styles.subsectionTitle, { color: uiTheme.textPrimary }]}
        ...
        <ThemedText
          style={[styles.paragraph, { color: uiTheme.textSecondary }]}
        >
          You can manage push notification preferences in the App settings or
        ...
        <ThemedText
          style={[styles.paragraph, { color: uiTheme.textSecondary }]}
        >
          You can disable location services through your device settings, though
        ...
        <ThemedText
          style={[styles.paragraph, { color: uiTheme.textSecondary }]}
        >
          The App does not currently respond to "Do Not Track" signals. We
          continue to review and may implement such signals in the future.
        </ThemedText>
        ...
        >
          ...
          personal information, please contact us immediately. If we become
        ...
        >
          ...
          App, you consent to the transfer of your information to these
          countries.
        </ThemedText>
        ...
        >
          ...
          agreements. When you delete your account, we will delete or anonymize
          your personal information, except where we are required to retain it
          for legal purposes.
        </ThemedText>
        ...
        >
          ...
          you of any material changes by posting the updated Privacy Policy in
          the App and updating the "Last Updated" date. Your continued use of
          the App after such modifications constitutes your acceptance of the
