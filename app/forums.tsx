...
export default function Forums() {
    ...
    const [pendingRadius, setPendingRadius] = useState<number>(20); // for the distance sheet
                ...
                <View style={styles.cardLeft}>
                    ...
                    <View style={styles.cardTextWrap}>
                        ...
                        <View style={styles.chipsRow}>
                            ...
                            <View style={styles.chip}>
                                <MaterialCommunityIcons name="tag-outline" size={14} color={textSecondary} />
    ...
    /* Distance preset chips for the sheet */
    ...
    return (
        <SafeAreaView style={styles.container} edges={['top', 'left', 'right']}>
            ...
            <View style={styles.actionsRow}>
                ...
                {/* Distance filter button (replaces Filters) */}
                <TouchableOpacity style={styles.actionBtn} onPress={() => setIsDistanceVisible(true)}>
                    <Ionicons name="locate-outline" size={18} color={textPrimary} />
            ...
            <Modal visible={isDistanceVisible} transparent animationType="fade" onRequestClose={() => setIsDistanceVisible(false)}>
                <Pressable style={styles.modalOverlay} onPress={() => setIsDistanceVisible(false)}>
                    <View style={[styles.modalSheet, { paddingBottom: 16 + insets.bottom }]}>
...
const styles = StyleSheet.create({
    ...
    actionText: { color: textPrimary, fontSize: 13, fontWeight: "600" },
    actionSpacer: { flex: 1 },

    tabsRow: { flexDirection: "row", gap: 8, paddingHorizontal: 14, paddingVertical: 8 },
    tab: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 999, backgroundColor: chipBg },
    tabActive: { backgroundColor: "#374151" },
    tabText: { color: textSecondary, fontSize: 13, fontWeight: "600" },
    tabTextActive: { color: textPrimary },
    ...
    cardTextWrap: { flex: 1 },
    cardTitle: { color: textPrimary, fontSize: 16, fontWeight: "700", marginBottom: 2 },
    cardSubtitle: { color: textSecondary, fontSize: 13, lineHeight: 18 },
    chipsRow: { flexDirection: "row", gap: 8, marginTop: 10 },
    chip: { flexDirection: "row", alignItems: "center", gap: 6, backgroundColor: chipBg, paddingHorizontal: 10, paddingVertical: 6, borderRadius: 999 },
    chipText: { color: textSecondary, fontSize: 12, fontWeight: "600" },

    emptyWrap: { alignItems: "center", paddingTop: 40, gap: 10 },
    emptyText: { color: textSecondary, fontSize: 14 },

    modalOverlay: { flex: 1, backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "flex-end" },
    modalSheet: { backgroundColor: cardBg, borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 16, borderTopWidth: 1, borderColor: divider },
    modalTitle: { color: textPrimary, fontWeight: "700", fontSize: 16, marginBottom: 12 },
    modalGrid: { flexDirection: "row", flexWrap: "wrap", gap: 16 },
    modalCell: { width: "47%", backgroundColor: chipBg, borderRadius: 14, padding: 14, alignItems: "center", gap: 8 },
    modalCellText: { color: textPrimary, fontWeight: "600" },

    /* Distance sheet */
    distanceRow: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginBottom: 16 },
    distanceChip: { backgroundColor: chipBg, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999 },
    distanceChipActive: { backgroundColor: "#374151" },
    distanceChipText: { color: textSecondary, fontWeight: "700" },
    distanceChipTextActive: { color: textPrimary },
    distanceFooter: { flexDirection: "row", alignItems: "center" },
    distanceHint: { color: textSecondary },
    primaryBtn: { backgroundColor: "#2563EB", paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12 },
    primaryBtnText: { color: "#fff", fontWeight: "700" },

    errorText: { color: "#FCA5A5", paddingHorizontal: 14, paddingBottom: 6 },
});
