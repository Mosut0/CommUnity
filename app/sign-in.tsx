  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
      ...
      >
        ...
        <TouchableOpacity style={styles.primaryBtn} onPress={handleSignIn} disabled={loading} activeOpacity={0.8}>
          {loading ? <ActivityIndicator color={theme.primaryBtnText} /> : <Text style={styles.primaryBtnText}>Sign In</Text>}
        </TouchableOpacity>
